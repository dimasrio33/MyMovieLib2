...
//                String name = mName.getText().toString().trim();
                ...
                if (password.equals(cnf_password)){
                    ...
                    if (val > 0){
                        Toast.makeText(RegisterActivity.this,"Registerasi Sukses!", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(RegisterActivity.this,"Password tidak benar!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
